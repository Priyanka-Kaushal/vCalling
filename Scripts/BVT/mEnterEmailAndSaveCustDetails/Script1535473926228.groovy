...
WebUI.setText(findTestObject('AddTeamMemberDashboard/email'), " ")

'Enter the number in the customer details'
...
'Click on customer details edit button'
WebUI.click(findTestObject('linkLog/editButton'))

WebUI.setText(findTestObject('Object Repository/customerDetailsEdit/emailInputBox'), CustomKeywords.'newPackage.newKeyword.randomString'(10) +
'@gmail.com')

WebUI.click(findTestObject('Object Repository/customerDetailsEdit/saveButtonObject'))

//if(WebUI.verifyElementPresent(findTestObject('Dashboard_Link Generator/validation'), 5)){
//  validationMessage = WebUI.getText(findTestObject('Dashboard_Link Generator/validation'))
//  WebUI.verifyMatch(validationMessage, GlobalVariable.countryCodeValidation, false)
//  println('successful')
//}else{
//  throw new Error('Alert not found')
//}
...
//WebUI.selectOptionByIndex(findTestObject('Object Repository/customerDetailsEdit/countryCode'), 0)

//WebUI.click(findTestObject('Object Repository/customerDetailsEdit/saveButtonObject'))

if(WebUI.verifyElementPresent(findTestObject('Dashboard_Link Generator/validation'), 5)){
	validationMessage = WebUI.getText(findTestObject('Dashboard_Link Generator/validation'))
	WebUI.verifyMatch(validationMessage, GlobalVariable.saveEditAlert, false)
	println('successful')
  }else{
	throw new Error('Alert not found')
  }
