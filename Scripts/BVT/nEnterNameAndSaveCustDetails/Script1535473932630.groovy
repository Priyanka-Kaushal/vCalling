...
WebUI.setText(findTestObject('AddTeamMemberDashboard/name'), " ")
...
//WebUI.click(findTestObject('Object Repository/linkLog/linkLogOpen'))
...
WebUI.setText(findTestObject('linkLog/nameEdit'), x+"a")
...
WebUI.clickOffset(findTestObject('Object Repository/customerDetailsEdit/customerDetailScreen'), 100, 100)
