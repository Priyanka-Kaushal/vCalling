...
WebUI.click(findTestObject('Object Repository/callLogs/acceptButton'))

WebUI.click(findTestObject('Object Repository/agentStories/stepInside button'))
WebUI.delay(2)
WebUI.click(findTestObject('Object Repository/callLogs/callEnd'))
WebUI.delay(6)
...
WebUI.callTestCase(findTestCase('commonFunctionality/durationFilter'), null)

WebUI.callTestCase(findTestCase('commonFunctionality/tagAndDurationFilter'), null)
WebUI.click(findTestObject('Object Repository/callLogs/refreshButton'))
WebUI.delay(6)
WebUI.callTestCase(findTestCase('commonFunctionality/durationAndTagFilter'), null)

WebUI.switchToWindowIndex(1)
WebUI.delay(2)
WebUI.click(findTestObject('Object Repository/callLogs/feedBackNoThankUButton'))
