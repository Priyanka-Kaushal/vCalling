...
linkLog = driver.findElements(By.xpath("/html/body/div[2]/div/div/div[2]/div[2]/div[1]/div[3]/div"))
println('linklogCount :' + linkLog.size())

sizeStore = linkLog.size();

linkGeneratorCount = driver.findElement(By.xpath("/html/body/div[2]/div/div/div[2]/div[2]/div[1]/div[2]/div[1]/div[2]")).getText();
