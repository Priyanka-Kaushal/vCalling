...
'click on SMS checkbox'
WebUI.click(findTestObject('Object Repository/Dashboard_Link Generator/checkbox_phone '))
...
WebUI.click(findTestObject('Object Repository/Dashboard_Link Generator/checkbox_mail'))
...
WebUI.delay(4)
/*---------------------------------*/
'click on callOnly checkbox'
WebUI.click(findTestObject('Object Repository/Dashboard_Link Generator/callOnly'))
//WebUI.click(findTestObject('Dashboard_Link Generator/div_GET LINK'))
