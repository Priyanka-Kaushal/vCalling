...
WebUI.sendKeys(findTestObject('Object Repository/customerDetailsEdit/emailInputBox'), Keys.chord(Keys.CONTROL + "a", Keys.DELETE))

WebUI.sendKeys(findTestObject('Object Repository/customerDetailsEdit/enterNumber'), Keys.chord(Keys.CONTROL + "a", Keys.DELETE))
...
if(WebUI.verifyElementPresent(findTestObject('Dashboard_Link Generator/validation'), 5)){
	validationMessage = WebUI.getText(findTestObject('Dashboard_Link Generator/validation'))
	WebUI.verifyMatch(validationMessage, GlobalVariable.removeCustomerDetailValidation, false)
	println('successful')
  }else{
	throw new Error('Alert not found')
  }
