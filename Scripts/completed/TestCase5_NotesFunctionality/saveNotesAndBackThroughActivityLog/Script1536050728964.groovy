...
if(WebUI.verifyElementPresent(findTestObject('Object Repository/Notes/saveNotesButton'), 2)){
	WebUI.click(findTestObject('Object Repository/Notes/saveNotesButton'))
	println('successful')
 }else{
	throw new Error('Add note button does not found')
 }
...
if(WebUI.verifyElementPresent(findTestObject('Dashboard_Link Generator/validation'), 5)){
  validationMessage = WebUI.getText(findTestObject('Dashboard_Link Generator/validation'))
  WebUI.verifyMatch(validationMessage, GlobalVariable.notesAddedValidation, false)
  println('successful')
}else{
  throw new Error('Alert not found')
}
  
'verify that click on the Activity Log Button'
if(WebUI.verifyElementPresent(findTestObject('Object Repository/Notes/activityLog'), 5)){
  WebUI.click(findTestObject('Object Repository/Notes/activityLog'))
  println('successful')
}else{
  throw new Error('Alert not found')
}
