...
WebUI.click(findTestObject('Object Repository/sideBarContainer/linkLogDataBase'))
...
WebUI.setText(findTestObject('Object Repository/PublicCustomer/customerNumber'), " ")

WebUI.setText(findTestObject('Object Repository/PublicCustomer/callOnlyEmail'), " ")
