...
WebUI.click(findTestObject('Object Repository/publicLinkGenerator/div_LINK LOGS DATABASE'))
...
WebUI.setText(findTestObject('Object Repository/PublicCustomer/customerId'), CustomKeywords.'newPackage.newKeyword.randomString'(10)+'@gmail.com')
...
//	}
	...
	List<WebElement> linkUserName = driver.findElements(By.className('text-log'))
